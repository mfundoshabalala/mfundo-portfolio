...
const Footer: React.FC = () => (
	<footer className="relative pt-10 pb-2 border border-gray-200 border-solid shadow-2xl mad:pt-8 md:px-8">
		<div className="container relative z-10 flex flex-col flex-wrap items-center justify-between mx-auto space-y-3">
			...
			<div className="flex flex-row flex-wrap justify-center w-full px-4 text-sm sm:space-y-0 md:space-x-2">
