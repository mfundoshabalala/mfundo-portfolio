...
const Footer: FunctionComponent = () => (
	<footer className="z-20 relative border border-solid border-gray-200 mt-12 pt-8 pb-2 px-2 md:px-8 shadow-2xl">
		<div className="container space-y-3 mx-auto flex flex-col flex-wrap justify-between items-center">
