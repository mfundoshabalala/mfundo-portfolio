					...
					<h3 className="text-4xl font-black tracking-tight text-center text-gray-600 uppercase font-body text-shadow">
						...
						<span className="inline-block w-8 h-8">
							<svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 512 512" viewBox="0 0 512 512">
								...
								<path
									fill="#db3328"
									d="M433.5,78.6l-355,355c98,98,256.9,98,355,0C531.5,335.5,531.5,176.6,433.5,78.6z"
								/>
								<polygon fill="#db3328" points="78.5 78.6 78.5 78.6 78.5 78.6" />
								<path
									fill="#b5100b"
									d="M248.4,263.9c1.8,1.9,4.4,3.1,7.3,3.1h251.1c0.3-7,0.3-14,0.1-20H265.3L248.4,263.9z"
								/>
